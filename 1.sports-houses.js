...
let submit1 = document.getElementById("simms-pop-up-link");
let popUpBox1 = document.getElementById("simms-pop-up");
...
function simmsResetForm(){
    var candidateVotes1 = document.getElementsByClassName("simms-votes");
    totalVotes1 = 0;
...
//counter for results
var totalVotes1 = 19; //total number of voting students


function simmsAddVote1(){
    voteCounter1++;
...
let submit2 = document.getElementById("mensah-pop-up-link");
let popUpBox2 = document.getElementById("mensah-pop-up");
...
function mensahResetForm(){
var candidateVotes2 = document.getElementsByClassName("mensah-votes");
...
let submit3 = document.getElementById("austin-pop-up-link");
let popUpBox3 = document.getElementById("austin-pop-up");
...
function austinResetForm(){
var candidateVotes3 = document.getElementsByClassName("austin-votes");
...
let submit4 = document.getElementById("halaby-pop-up-link");
let popUpBox4 = document.getElementById("halaby-pop-up");
...
function halabyResetForm(){
var candidateVotes4 = document.getElementsByClassName("halaby-votes");
...
candidateVotes4[2].innerHTML = "";
voteCounter21 = 0;

candidateVotes4[3].innerHTML = "";
voteCounter22 = 0;

candidateVotes4[4].innerHTML = "";
voteCounter23 = 0;

candidateVotes4[5].innerHTML = "";
voteCounter24 = 0;
